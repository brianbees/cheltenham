"""
Parse William Hill racecard CSV (all races in one file) → compute Harville EV → save to Supabase.
...
Usage:
  python _scripts/_parse_williamhill_csv.py <path-to-csv>
  e.g. python _scripts/_parse_williamhill_csv.py "chelt wednsday races and odds - Sheet5 (1).csv"
"""
