  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-4 font-sans">
      ...
      {years.map((yearData) => (
        <div
          key={yearData.year}
          className="mb-10 border border-gray-800 rounded-xl overflow-hidden"
        >
          {/* Year header */}
          <div className="bg-gray-900 px-4 py-3 flex items-center justify-between">
            <div>
              <span className="text-xl font-bold text-white">{yearData.year}</span>
              <span className="ml-3 text-gray-400 text-sm">{yearData.date}</span>
            </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-900 border-b border-gray-800">
                  <th className="text-left px-4 py-2 text-gray-400 font-medium w-40">Race</th>
                  <th className="text-left px-4 py-2 text-gray-400 font-medium">1st</th>
                  <th className="text-left px-4 py-2 text-gray-400 font-medium">2nd</th>
                  <th className="text-left px-4 py-2 text-gray-400 font-medium">3rd</th>
                  <th className="text-right px-4 py-2 text-gray-400 font-medium">SP pts</th>
                  <th className="text-right px-4 py-2 text-gray-400 font-medium">+Bonuses</th>
                      ...
                      {race.top3.map((horse, pos) => (
                        <td key={pos} className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="text-gray-100 text-xs font-medium leading-tight">
                                {horse.horseName}
                              </div>
          ...
          <div className="bg-gray-900 px-4 py-3 flex items-center gap-6 border-t border-gray-800">
      ...
      <div className="border border-gray-800 rounded-xl overflow-hidden mb-8">
        <div className="bg-gray-900 px-4 py-3">
          <h2 className="text-lg font-bold text-white">All-Time Winners</h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-900/50 border-b border-gray-800">
              ...
              <th className="text-right px-4 py-2 text-gray-400 font-medium">Winning Score</th>
              <th className="text-right px-4 py-2 text-gray-400 font-medium">Theoretical Max</th>
            </tr>
          </thead>
          <tbody>
