    ...
    races: [
      {
        ...
        fieldSize: 15,
        top3: [
          { gatePosition: 16, horseName: "Vauban",     sp:  2.5  },
          { gatePosition:  7, horseName: "Fil Dor",    sp:  4.5  },
          { gatePosition: 14, horseName: "Pied Piper", sp:  5.5  },
        ],
        field: [
          { gatePosition:  1, horseName: "Bell Ex One",       sp: 41.0,  finishPosition: 11 },
          { gatePosition:  2, horseName: "Brazil",            sp: 10.0,  finishPosition: null }, // PU
          { gatePosition:  4, horseName: "Champion Green",    sp: 81.0,  finishPosition: null }, // PU
          { gatePosition:  5, horseName: "Dixon Cove",        sp: 51.0,  finishPosition:  9 },
          { gatePosition:  6, horseName: "Doctor Bravo",      sp: 21.0,  finishPosition:  5 },
          { gatePosition:  7, horseName: "Fil Dor",           sp:  4.5,  finishPosition:  2 },
          { gatePosition:  8, horseName: "Forever Charming",  sp: 67.0,  finishPosition: 10 },
          { gatePosition:  9, horseName: "Graystone",         sp: 126.0, finishPosition: null }, // PU
          { gatePosition: 10, horseName: "Icare Allen",       sp: 11.0,  finishPosition:  8 },
          { gatePosition: 11, horseName: "In The Air",        sp: 101.0, finishPosition: null }, // PU
          { gatePosition: 12, horseName: "Il Etait Temps",    sp: 11.0,  finishPosition:  6 },
          { gatePosition: 13, horseName: "Knight Salute",     sp: 15.0,  finishPosition:  7 },
          { gatePosition: 14, horseName: "Pied Piper",        sp:  5.5,  finishPosition:  3 },
          { gatePosition: 15, horseName: "Porticello",        sp: 12.0,  finishPosition:  4 },
          { gatePosition: 16, horseName: "Vauban",            sp:  2.5,  finishPosition:  1 },
        ],
      },
      {
        raceName: "County Hurdle",
        fieldSize: 25,
        top3: [
          { gatePosition: 17, horseName: "State Man",       sp:  3.75 },
          { gatePosition:  1, horseName: "First Street",    sp: 17.0  },
          { gatePosition: 15, horseName: "Colonel Mustard", sp:  7.5  },
        ],
        field: [
          { gatePosition:  1, horseName: "First Street",       sp: 17.0,  finishPosition:  2 },
          { gatePosition:  2, horseName: "Pied Piper",         sp: 15.0,  finishPosition:  7 },
          { gatePosition:  3, horseName: "Lucky Max",          sp: 26.0,  finishPosition: 24 },
          { gatePosition:  4, horseName: "West Cork",          sp:  7.5,  finishPosition:  4 },
          { gatePosition:  5, horseName: "Champagne Gold",     sp: 29.0,  finishPosition: 19 },
          { gatePosition:  6, horseName: "Greatwood",          sp: 51.0,  finishPosition: 17 },
          { gatePosition:  7, horseName: "Stepney Causeway",   sp: 41.0,  finishPosition: 10 },
          { gatePosition:  8, horseName: "I Like To Move It",  sp: 17.0,  finishPosition: 18 },
          { gatePosition:  9, horseName: "Triple Trade",       sp: 26.0,  finishPosition:  5 },
          { gatePosition: 10, horseName: "Broomfield Burg",    sp: 10.0,  finishPosition: 14 },
          { gatePosition: 11, horseName: "Anna Bunina",        sp: 51.0,  finishPosition: 15 },
          { gatePosition: 12, horseName: "Ciel de Neige",      sp: 13.0,  finishPosition: 12 },
          { gatePosition: 13, horseName: "Captain Conby",      sp: 26.0,  finishPosition: 23 },
          { gatePosition: 14, horseName: "Call Me Lyreen",     sp: 17.0,  finishPosition: 16 },
          { gatePosition: 15, horseName: "Colonel Mustard",    sp:  7.5,  finishPosition:  3 },
          { gatePosition: 16, horseName: "Playful Saint",      sp: 34.0,  finishPosition: 25 },
          { gatePosition: 17, horseName: "State Man",          sp:  3.75, finishPosition:  1 },
          { gatePosition: 18, horseName: "Autumn Evening",     sp: 15.0,  finishPosition: 13 },
          { gatePosition: 19, horseName: "Petit Tonnerre",     sp: 13.0,  finishPosition:  6 },
          { gatePosition: 20, horseName: "Ganapathi",          sp: 29.0,  finishPosition: 11 },
          { gatePosition: 21, horseName: "Farout",             sp: 51.0,  finishPosition: 20 },
          { gatePosition: 22, horseName: "Top Bandit",         sp: 17.0,  finishPosition:  8 },
          { gatePosition: 23, horseName: "Eclair de Beaufeu",  sp: 51.0,  finishPosition: 21 },
          { gatePosition: 24, horseName: "Mickey Bobo",        sp: 26.0,  finishPosition:  9 }, // cloth 24 — name may need verification
          { gatePosition: 25, horseName: "Too Friendly",       sp: 34.0,  finishPosition: 22 },
        ],
      },
      {
        raceName: "Albert Bartlett",
        fieldSize: 17,
        top3: [
          { gatePosition: 16, horseName: "The Nice Guy",      sp: 19.0 },
          { gatePosition: 11, horseName: "Minella Cocooner",  sp:  5.5 },
          { gatePosition:  2, horseName: "Bardenstown Lad",   sp: 21.0 },
        ],
        field: [
          { gatePosition:  1, horseName: "Absolute Notions",     sp: 67.0,  finishPosition: 14 },
          { gatePosition:  2, horseName: "Bardenstown Lad",      sp: 21.0,  finishPosition:  3 },
          { gatePosition:  3, horseName: "Ballygrifincottage",   sp: 29.0,  finishPosition:  4 },
          { gatePosition:  4, horseName: "Good Ball",            sp: 21.0,  finishPosition: null }, // PU
          { gatePosition:  5, horseName: "Hillcrest",            sp:  4.5,  finishPosition:  7 },
          { gatePosition:  6, horseName: "Jet Powered",          sp: 13.0,  finishPosition: 12 },
          { gatePosition:  8, horseName: "Desertmore House",     sp: 34.0,  finishPosition: null }, // PU
          { gatePosition:  9, horseName: "Kilcruit",             sp:  7.0,  finishPosition: null }, // PU
          { gatePosition: 10, horseName: "Mahler Mission",       sp: 41.0,  finishPosition:  8 },
          { gatePosition: 11, horseName: "Minella Cocooner",     sp:  5.5,  finishPosition:  2 },
          { gatePosition: 12, horseName: "Presentling",          sp: 34.0,  finishPosition:  6 },
          { gatePosition: 13, horseName: "Readin Tommy Wrong",   sp: 17.0,  finishPosition: 10 },
          { gatePosition: 14, horseName: "Sheradann",            sp: 51.0,  finishPosition: 13 },
          { gatePosition: 15, horseName: "Stag Horn",            sp: 12.0,  finishPosition:  9 },
          { gatePosition: 16, horseName: "The Nice Guy",         sp: 19.0,  finishPosition:  1 },
          { gatePosition: 17, horseName: "Gringo d'Aubrelle",    sp: 15.0,  finishPosition:  5 },
          { gatePosition: 18, horseName: "Green Book",           sp: 26.0,  finishPosition: 11 },
        ],
      },
      {
        raceName: "Gold Cup",
        ...
        field: [
          ...
          { gatePosition:  4, horseName: "Galvin",           sp:  4.333, finishPosition: 4 },
          ...
          { gatePosition:  9, horseName: "Aye Right",        sp: 81.0,  finishPosition:  9 },
          { gatePosition: 10, horseName: "Santini",          sp: 67.0,  finishPosition:  8 },
          { gatePosition: 11, horseName: "Royale Pagaille",  sp: 21.0,  finishPosition:  5 },
          { gatePosition: 12, horseName: "Tornado Flyer",    sp: 10.0,  finishPosition: null }, // PU
        ],
      },
      {
        raceName: "Hunters Chase",
        ...
        field: [
          { gatePosition:  1, horseName: "Bob And Co",      sp: 12.0,  finishPosition:  8 },
          { gatePosition:  2, horseName: "Billaway",        sp:  2.625, finishPosition: 1 },
          { gatePosition:  3, horseName: "Brain Power",     sp: 41.0,  finishPosition: null }, // PU
          { gatePosition:  4, horseName: "Cat Tiger",       sp: 15.0,  finishPosition:  7 },
          { gatePosition:  6, horseName: "Vaucelet",        sp: 11.0,  finishPosition:  5 },
          { gatePosition:  7, horseName: "Wagner",          sp: 67.0,  finishPosition:  4 },
          { gatePosition:  8, horseName: "Dubai Quest",     sp: 11.0,  finishPosition: 10 },
          { gatePosition:  9, horseName: "Ferns Lock",      sp: 21.0,  finishPosition: null }, // PU
          { gatePosition: 10, horseName: "I K Brunel",      sp: 101.0, finishPosition: null }, // PU
          { gatePosition: 11, horseName: "Mighty Stowaway", sp: 34.0,  finishPosition:  3 },
          { gatePosition: 12, horseName: "Secret Investor", sp: 21.0,  finishPosition: null }, // PU
          { gatePosition: 15, horseName: "Latenightpass",   sp: 13.0,  finishPosition:  6 },
          { gatePosition: 19, horseName: "Winged Leader",   sp:  5.5,  finishPosition:  2 },
          { gatePosition: 20, horseName: "Porlock Bay",     sp: 26.0,  finishPosition:  9 },
        ],
      },
      {
        raceName: "Mares Chase",
        ...
        field: [
          { gatePosition: 1, horseName: "Concertista",        sp:  2.875, finishPosition: 5 },
          ...
          { gatePosition: 4, horseName: "Mount Ida",          sp:  3.75, finishPosition:  6 },
          { gatePosition: 5, horseName: "Zambella",           sp: 17.0,  finishPosition:  4 },
          { gatePosition: 6, horseName: "Pink Legend",        sp: 34.0,  finishPosition:  2 },
          { gatePosition: 7, horseName: "Dame de Compagnie",  sp: 26.0,  finishPosition:  7 },
        ],
      },
      {
        raceName: "Martin Pipe",
        fieldSize: 23,
        top3: [
          { gatePosition: 22, horseName: "Banbridge",       sp: 13.0 },
          { gatePosition:  9, horseName: "Cobblers Dream",  sp: 13.0 },
          { gatePosition:  1, horseName: "Hollow Games",    sp:  6.5 },
        ],
        field: [
          { gatePosition:  1, horseName: "Hollow Games",       sp:  6.5,  finishPosition:  3 },
          { gatePosition:  2, horseName: "Chemical Energy",    sp: 19.0,  finishPosition: 14 },
          { gatePosition:  3, horseName: "Freedom To Dream",   sp: 26.0,  finishPosition:  4 },
          { gatePosition:  4, horseName: "Bellatrixsa",        sp: 34.0,  finishPosition: 11 },
          { gatePosition:  5, horseName: "Silver Sheen",       sp: 51.0,  finishPosition:  8 },
          { gatePosition:  6, horseName: "The Brimming Water", sp: 21.0,  finishPosition:  7 },
          { gatePosition:  7, horseName: "Howth",              sp: 21.0,  finishPosition: 13 },
          { gatePosition:  8, horseName: "Marble Sands",       sp: 51.0,  finishPosition: 15 },
          { gatePosition:  9, horseName: "Cobblers Dream",     sp: 13.0,  finishPosition:  2 },
          { gatePosition: 10, horseName: "Au Fleuron",         sp: 17.0,  finishPosition: 10 },
          { gatePosition: 11, horseName: "Ambitious",          sp: 101.0, finishPosition: 17 },
          { gatePosition: 12, horseName: "I A M Maximus",      sp: 15.0,  finishPosition:  9 },
          { gatePosition: 13, horseName: "Gentleman De Mee",   sp: 11.0,  finishPosition: null }, // PU
          { gatePosition: 14, horseName: "Vocal Duke",         sp: 67.0,  finishPosition: 16 },
          { gatePosition: 15, horseName: "Unexpected Party",   sp: 15.0,  finishPosition: null }, // PU
          { gatePosition: 16, horseName: "Balco Coastal",      sp: 11.0,  finishPosition: null }, // PU
          { gatePosition: 18, horseName: "Grand Jury",         sp: 17.0,  finishPosition:  5 },
          { gatePosition: 19, horseName: "Saint D'Oroux",      sp: 41.0,  finishPosition: null }, // PU
          { gatePosition: 20, horseName: "Lucky Tenner",       sp: 67.0,  finishPosition: null }, // PU
          { gatePosition: 21, horseName: "Winter Fog",         sp: 10.0,  finishPosition: null }, // PU
          { gatePosition: 22, horseName: "Banbridge",          sp: 13.0,  finishPosition:  1 },
          { gatePosition: 23, horseName: "Party Business",     sp: 15.0,  finishPosition: 12 },
          { gatePosition: 24, horseName: "Ebasari",            sp: 34.0,  finishPosition:  6 },
        ],
      },
    ],
    leaderboard: [
